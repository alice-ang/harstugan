<template>
  <div class="footer-container">
    ...
    <div id="opening">
      ...
      <p>
        Tel: 0587-100 34 <br />
        Prästgatan 5B, 713 31 Nora.
      </p>
      <span class="socials">
        <a href="https://www.instagram.com/harstugan/" target="_blank"
          ><i class="fab fa-instagram"></i
        ></a>
        <a
          href="https://www.facebook.com/H%C3%A5rstugan-264806910204747/"
          target="_blank"
    ...
    <div class="footer-info">
      <p>
        Copyright &copy; {{ year }} | Utvecklad med
        <span id="heart"> &hearts;</span> av
        <a href="https://alice-ang.github.io/" target="_blank"> Alice </a> &amp;
        Ludwig
      </p>
    </div>
  </div>
